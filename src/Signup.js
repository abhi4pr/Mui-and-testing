...
function Signup() {
  // sx for style and mt for marginTop
  ...
  const handleReg = async(event) => {
    ...
    await axios({
      method: 'post',
      url: 'http://3.141.33.10:3100/api/registeruser',
      data: {
          name: 'user1',
      ...
      <Grid container sx={{ mt: 10 }}> 
        ...
        <Grid item xs={6}>
            <Card>
              ...
              <form method='POST' onSubmit={handleReg} data-testid="regform">
                <TextField
                  id="name"
                  name="name"
                  label="Name"
                ...
                <Button type="submit" disabled={!inputField.email} variant="contained" fullWidth color="primary" sx={{mt:3}}>
                  Register
                </Button>
              </form>
              </CardContent>  
